...
MASTERS = [
    {
        ...
        "description": "Мастер с опытом работы",
        "work_experience": 10,
    },
    {
        "id": 2,
        "name": "Зоя 'Ножницы' Космодемьянская",
        "description": "Мастер с 8-летним опытом работы",
        "work_experience": 8,
    },
    {
        "id": 3,
        "name": "Борис 'Фен' Пастернак",
        "description": "Мастер с 12-летним опытом работы",
        "work_experience": 12,
    },
    {
        "id": 4,
        "name": "Иннокентий 'Лак' Смоктуновский",
        "description": "Мастер с 15-летним опытом работы",
        "work_experience": 15,
    },
    {
        "id": 5,
        "name": "Раиса 'Бигуди' Горбачёва",
        "description": "Мастер с 9-летним опытом работы",
        "work_experience": 9,
    },
]
